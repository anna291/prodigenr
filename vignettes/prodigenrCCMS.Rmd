...
# install_github("ccmsLIH/prodigenrCCMS") # only needs to be installed once
...
Or via RStudio's interface (only for prodigenr, not prodigenrCCMS) (with RStudio version >1.1):
...
prodigenrCCMS:::viz_project_tree(new_project_path)
```
